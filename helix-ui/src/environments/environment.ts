export const environment = {
    ...
    TABS: [
      { path: 'ring', label: 'Hash Ring', dot: '#00c8ff'},
      { path: 'distribution', label: 'Distribution', dot: '#aa55ff'},
      { path: 'hot-keys', label: 'Hot Keys', dot: '#ff4466'},
      { path: 'log', label: 'Log', dot: '#00ff88'},
    ]
